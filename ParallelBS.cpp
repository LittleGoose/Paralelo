...
void bitonicSortSerial(int array[], int l_index, int count, int direction);
...
int main() {
	...
	const long int array_size = 1 << 11;		// tamanio del array
	const long int n_range = 1 << 11;			// rango de numeros del array
	...
	int count = array_size;			// tamanio del array
	int direction = 1;				// creciente
	omp_set_num_threads(NTHREADS);	// set threads
